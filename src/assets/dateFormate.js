    ...
    if (date) {
      ...
      switch (type) {
        case this.WEEKTYPE.ZH_DAYNAME:
          dateStr = date_formate_options.ZH.dayNames[index];
          break;
        case this.WEEKTYPE.ZH_SDAYNAME:
          dateStr = date_formate_options.ZH.shortDayNames[index];
          break;
        case this.WEEKTYPE.US_DAYNAME:
          dateStr = date_formate_options.US.dayNames[index];
          break;
        case this.WEEKTYPE.US_SDAYNAME:
          dateStr = date_formate_options.US.shortDayNames[index];
          break;
      }
      return dateStr;
    }
